...
public class admindashboardImpl implements admindashboard {
	...
	public void dashboard() throws GlobalException {
		...
		int op=0;
		while (op<10) {
			log.info("\tPress 1 : To create room \t\tPress 2 :To allot room to users \n\tPress 3 :To view rooms \t\tPress 4 :To view users \n\tPress 5 :To view users in a room \t\tPress 6 :To view user profile \n\tPress 7 :To add dues \t\tPress 8 :To show dues to paid \n\tPress 9 :To delete a user");
			op=sc.nextInt();
	...
	public void viewRooms() {
		...
		for (room r : st){
			...
			log.info("\tRoom Id Is"+r.getRoomId()+"\tRoom Name Is"+r.getRoomName()+"\tRoom Type Is"+r.getRoomType());
		}
	...
	public void viewUsers() {
		...
		for(user u :st) {
			log.info("\tUser id is"+u.getUserId()+"\tUser Name is"+u.getUserName()+"\tUser password"+u.getUserPassword()+"\tUser addres is"+u.getUserAddress()+"\tUser fee is"+u.getUserFee()+"\tUser phone is"+u.getUserPhone()+"\tUser Role is"+u.getUserRole());
		}
	}
